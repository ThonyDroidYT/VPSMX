...
kalix1="aHR0cHM6Ly93d3cudGRwcm95ZWN0b3MudGsvVlBTTVgvdmVyc2lvbi84LjRlL0VOQ1JJUFQ="
PUTO='base64 -d'
...
wget -O $HOME/systemverify https://www.tdproyectos.tk/VPSMX/Install/systemverify &> /dev/null
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/tiemlim.log &>/dev/null

wget -O /bin/rebootnb https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/resetsshdrop &> /dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://www.tdproyectos.tk/VPSMX/Install/Version &>/dev/null
msg -bar2
...
echo 'wget -O /etc/versin_script_new https://www.tdproyectos.tk/VPSMX/Install/Version &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
fun_ip
wget -O /usr/bin/trans https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://www.tdproyectos.tk/VPSMX/Install/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://www.tdproyectos.tk/VPSMX/Install/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://www.tdproyectos.tk/VPSMX/Install/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Kalix1 ❌\033[1;33m ]"
